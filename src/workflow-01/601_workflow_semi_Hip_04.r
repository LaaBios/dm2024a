...
CA_catastrophe_base <- function( pinputexps, metodo )
{
  ...
  param_local$meta$script <- "/src/workflow-01/521_CA_reparar_dataset_mice_pmm.r"                                        #CAMBIO POR RECOMENDACION
...
FEhist_base <- function( pinputexps)
{
  ...
  param_local$lag3 <- TRUE #FALSE # no me engraso con los lags de orden 3                                                #CAMBIO POR RECOMENDACION
...
wf_semillerio9 <- function( pnombrewf )
{
  ...
  CN_canaritos_asesinos_base(ratio=0.2, desvio=4)                                                                             #CAMBIO POR RECOMENDACION
