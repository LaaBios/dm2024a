...
modelo <- rpart(
        formula = "clase_ternaria ~ . - ccomisiones_otras - Visa_msaldodolares - Master_fultimo_cierre - Master_madelantodolares - Visa_mfinanciacion_limite - minversion2 - ccajeros_propios_descuentos - ctarjeta_visa_descuentos - ctarjeta_master_descuentos - mforex_buy - catm_trx - Master_Finiciomora - Visa_mconsumosdolares",
